...
A self-hosted dashboard that aggregates cybersecurity news from RSS feeds, deduplicates articles, scores them on a DEFCON-style threat scale (5 to 1), and presents everything through a real-time web interface.
